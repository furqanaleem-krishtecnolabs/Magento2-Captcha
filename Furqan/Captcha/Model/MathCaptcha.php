...
namespace Furqan\Captcha\Model;
...
use Furqan\Captcha\Model\Config\ExpressionType;
use Furqan\Captcha\Model\ExpressionGenerator as Generator;
...
class MathCaptcha extends DefaultModel
{
    ...
    {
        return \Furqan\Captcha\Block\Captcha\MathCaptcha::class;
    }
